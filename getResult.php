  ...
  <body>
    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
	   ...
	   <h1 class="form-signin-heading">RESULT PANEL</h1>
       <form action="ctr_fetch_result.php" method="post" class="form-signin">
	   ...
	   <input type="password" name="txtpass" placeholder="Password" class="form-control" required autofocus><br><br>
