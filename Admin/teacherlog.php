	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../form/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="./teachlogin.php">
					<span class="login100-form-title p-b-49">
						Login
					</span>
          <div class="wrap-input100 validate-input m-b-23" data-validate = "select the type">
						<span class="label-input100">User Type</span>
						<select class="input100" onchange="javascript:handleSelect(this)" name="type">
						<option value="teacherlog">TEACHERS</option>
						<option value="LoginFrm">ADMIN</option>
                          </select>
						
					</div>
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span class="label-input100">Username</span>
						<input class="input100" type="text"name="txtid" placeholder="Type your username">
